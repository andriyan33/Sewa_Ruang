                    ...
                    <div class="table-responsive">
                        <table class="table" style="color: white;">
                            <tr>
                                ...
                                <th style="text-align: center;">Alasan</td>
                            ...
                            <?php
                                ...
                                $mysql = new MySQL();
                                $mysql->connect();
                                $mysql->execute("SELECT ruangan, tanggal_peminjaman, jumlah, id_peminjaman, alasan FROM peminjaman");
                                ...
                                if($mysql->get_num_rows() != null){
                                    ...
                                    echo '
                                        ...
                                        <td style="text-align: center;"><a href="edit.php?id='.$row['id_peminjaman'].'"><button type="button" class="btn btn-success">Edit</button></a> | <a href="hapus.php?id='.$row['id_peminjaman'].'"><button type="button" class="btn btn-danger">Hapus</button></a>
                                    ...
                                    echo '<font size = "5" color = "red " face = " fantasy""><center>Your data is Empty</center></font>';
                                }
